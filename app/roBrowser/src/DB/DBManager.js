...
define(function(require)
{
	...
	/**
	 * @var {Array} quest display metadata
	 */
	var QuestTable = [];
	...
	DB.init = function init()
	{
		...
		loadTable( 'data/questid2display.txt',             2, function(index, key, val){
			QuestTable.push({ id: parseInt(key, 10), title: val });
		}, onLoad());
	};

	DB.getQuestList = function getQuestList()
	{
		return QuestTable;
	};
